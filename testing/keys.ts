...
let _publicKey1: CryptographicKey | undefined = undefined;

export async function publicKey1(): Promise<CryptographicKey> {
  if (_publicKey1 !== undefined) return _publicKey1;
  return _publicKey1 = new CryptographicKey({
...
let _privateKey2: CryptoKey | undefined = undefined;

export async function privateKey2(): Promise<CryptoKey> {
  if (_privateKey2 !== undefined) return _privateKey2;
  return _privateKey2 = await crypto.subtle.importKey(
    "jwk",
    {
      "kty": "RSA",
      "alg": "RS256",
...
let _publicKey2: CryptographicKey | undefined = undefined;

export async function publicKey2(): Promise<CryptographicKey> {
  if (_publicKey2 !== undefined) return _publicKey2;
  return _publicKey2 = new CryptographicKey({
